            ...
            <div class="card-body">
                ...
                <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telephone" class="form-control" value="<?= $row['telephone'];?>">
                    </div>
                ...
                if(isset($_POST['submit'])) {
                   ...
                   mysqli_query($koneksi,"update siswa set nama='$nama',telephone='$telephone' where id = '$id'") or die(mysqli_error($koneksi));
